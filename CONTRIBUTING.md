...
- Include environment details (OS, versions, etc.) where relevant

### Pull Requests

1. **Fork** the repository and create a branch from `main`
2. **Make changes** following existing code style and conventions
3. **Test** locally as applicable
...
- Add docstrings for new functions and modules where appropriate

### Documentation

- Update README when adding new features or configuration
